...
const DataTable = ({
  ...
  const [pageInput, setPageInput] = useState(pagination?.currentPage || 1);
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50/50 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-2 border rounded-lg hover:bg-white transition-colors disabled:opacity-30 disabled:hover:bg-transparent"
            >
              Last
            </button>
          </div>
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-20 px-2 py-1 border rounded-lg text-sm outline-none focus:ring-1 focus:ring-blue-500"
            />
            <button
              onClick={handlePageJump}
              className="px-3 py-1 border rounded-lg text-sm bg-white hover:bg-blue-50 transition-colors"
            >
              Go
            </button>
